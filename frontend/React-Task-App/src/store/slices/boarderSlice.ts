...
const boardsSlice = createSlice({
    ...
    reducers: {
        ...
        deleteTask: (state,
          {payload}: PayloadAction<TDeleteTaskAction>) => {
            state.boardArray = state.boardArray.map(board =>
              board.boardId === payload.boardId
                ?
                {
...
export const {sort, addBoard, deleteList, deleteTask, updateTask, setModalActive, addTask, addList, deleteBoard} = boardsSlice.actions;
